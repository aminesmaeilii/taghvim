...
function UserManagementPanel() {
  ...
  const remove = async (user: SafeUser) => { if (user.id === currentUser?.id || !confirm(`کاربر ${user.username} حذف شود؟`)) return; await authService.softDeleteUser(user.id); load(); pushToast({ title: "کاربر حذف شد." }); };
